...
import layoutConfig from "@/layouts/backend-layout/config/DefaultLayoutConfig";
import { Mutations } from "@/store/enums/StoreEnums";
import { Mutation, Module, VuexModule } from "vuex-module-decorators";
import LayoutConfigTypes from "@/layouts/backend-layout/config/LayoutConfigTypes";
...
export default class ConfigModule extends VuexModule implements StoreInfo {
  ...
  @Mutation
  [Mutations.SET_BACKEND_LAYOUT_CONFIG_PROPERTY](payload): void {
  ...
  @Mutation
  [Mutations.RESET_BACKEND_LAYOUT_CONFIG]() {
    this.config = Object.assign({}, this.initial);
  }

  @Mutation
  [Mutations.OVERRIDE_BACKEND_LAYOUT_CONFIG](): void {
  ...
  @Mutation
  [Mutations.OVERRIDE_BACKEND_PAGE_LAYOUT_CONFIG](payload): void {
