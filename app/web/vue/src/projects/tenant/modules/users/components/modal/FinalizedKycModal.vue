<template>
  <SimpleForm
    ...
    :min-height="775"
    :min-width="1000"
    :saveTitle="$t('action.download')"
    :submit="convertToPdf"
  >
    <div
      id="new-kyc-form"
      style="position: relative; padding: 3px 20px"
      class="font"
    >
      ...
      <div>
        ...
        <table style="width: 100%">
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.lastName }}</td>
            <td class="kyc-label-col-2">
              <span>Given Name:</span>
              <br />
              <span>名</span>
            </td>
            <td class="kyc-input-col-3">{{ kycInfos.firstName }}</td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.priorName }}</td>
            <td class="kyc-label-col-2">
              <span>Date of Birth</span>
              <br />
              <span>出生日期</span>
            </td>
            <td class="kyc-input-col-3">{{ kycInfos.birthday }}</td>
          </tr>
            ...
            <td colspan="2" class="kyc-input-col-3">
              <div style="font-size: 12px">
                ...
                <strong class="ms-2" style="text-transform: uppercase"
                  >{{ kycInfos.citizen }} Citizen</strong
                >
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">
              {{ $t("fields.range_" + kycInfos.annualIncome) }}
            </td>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">
              {{ $t("fields.range_" + kycInfos.netWorth) }}
            </td>
          </tr>
          ...
          <tr>
            <td colspan="2" class="kyc-label-col-2">
              <span
                >Have you ever attended an education seminar or course on
                trading Stocks, Bonds, Contracts-for-difference, Forex,
                Derivatives, or other securities trading?</span
              >
              <br />
              <span
                >您是否参加过有关股票,债券,差价合约,外汇,衍生品或其他证券交易的教育研讨会或课程?</span
              >
            </td>
          ...
          <tr>
            <td colspan="2" class="kyc-label-col-2">
              <span
                ...
                Contracts-for-difference, Forex, Derivatives, or other
                securities trading account?</span
              >
              <br />
              <span
              ...
              <div style="font-size: 12px">
                ...
                <div class="ms-4 mt-3">
                  <ul>
                    <li class="mt-2">
                      Employer/公司 :
                      <span class="ms-3">{{ kycInfos.exp1Employer }}</span>
                    </li>
                    <li class="mt-2">
                      Position/職位 :
                      <span class="ms-3">{{ kycInfos.exp1Position }}</span>
                    </li>
                    <li class="mt-2">
                      Remuneration/报酬 :
                      <span class="ms-3">{{ kycInfos.exp1Remuneration }}</span>
                    </li>
                  </ul>
                </div>
                <div class="d-flex align-items-center">
              ...
              <div style="font-size: 12px">
                <div class="d-flex align-items-center">
                  <input
                    class="me-4"
                    type="checkbox"
                    :checked="kycInfos.exp2 == 0"
                  />
                  <div>
                    Yes, please indicate the date of discharge and provide a
                    copy of the discharge letter with your application tip.
                    <br />
                ...
                <div class="ms-8 mt-3 mb-3">
                  Date:<span class="ms-3">{{ kycInfos.exp2More }}</span>
                </div>
                <div class="d-flex align-items-center">
                  <input
                    class="me-4"
                    type="checkbox"
                    :checked="kycInfos.exp2 == 1"
                  />
                  <div>NO/否</div>
                </div>
              </div>
          ...
          <tr>
            <td colspan="2" class="kyc-label-col-2">
              <span
                >Are you or any person having an interest in this account a
                member or employee of a commodity exchange or regulatory
                agency?</span
              >
              <br />
              <span
              ...
              <div style="font-size: 12px">
                <div class="d-flex align-items-center mb-3">
                  <input
                    class="me-4"
                    type="checkbox"
                    :checked="kycInfos.exp4 == 0"
                  />
                  <div>
                    Yes Please provide details/是, 请提供细节:<span
                      class="ms-3"
                      >{{ kycInfos.exp4More }}</span
                    >
                  </div>
                </div>
                <div class="d-flex align-items-center">
              ...
              <div style="font-size: 12px">
                <div class="d-flex align-items-center mb-3">
                  <input
                    class="me-4"
                    type="checkbox"
                    :checked="kycInfos.exp5 == 0"
                  />
                  <div>
                    Yes Please provide details/是, 请提供细节:<span
                      class="ms-3"
                      >{{ kycInfos.exp5More }}</span
                    >
                  </div>
                </div>
                <div class="d-flex align-items-center">
        ...
        <table style="width: 100%">
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.businessName }}</td>
            <td class="kyc-label-col-2">
              <span>Business Number</span>
              <br />
              <span>商務號碼</span>
            </td>
            <td class="kyc-input-col-3">{{ kycInfos.businessNumber }}</td>
          </tr>
              ...
              <div class="d-flex" style="font-size: 12px">
                <div style="width: 50%">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-5 fs-3">
                      {{ kycInfos.businessCity }}
                    </div>
                  </div>
                  <div class="d-flex align-items-center">
                    <div>Zip/Postal<br />邮编</div>
                    <div class="ms-5 fs-3">
                      {{ kycInfos.businessZipCode }}
                    </div>
                  </div>
                </div>
                ...
                <div style="width: 50%">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-5 fs-3">
                      {{ kycInfos.businessState }}
                    </div>
                  </div>
                  <div class="d-flex align-items-center">
                    <div>Country<br />国家</div>
                    <div class="ms-5 fs-3">
                      {{ kycInfos.businessCountry }}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">
              {{ kycInfos.businessServiceRequireReason }}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">
              <div>
                ...
                >{{ kycInfos.businessClientIndustry1 }}
              </div>
              <div>
                <span class="me-3">2.</span
                >{{ kycInfos.businessClientIndustry2 }}
              </div>
              <div>
                <span class="me-3">3.</span
                >{{ kycInfos.businessClientIndustry3 }}
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td class="kyc-label-col-2">
              <span
                >An explanation of a typical service provided by the client to
                its customers</span
              >
              <br />
        ...
        <table style="width: 100%">
          <tr>
            ...
            <td class="kyc-input-col-3">
              <span v-if="kycInfos.idType == 1">Passport</span>
              <span v-if="kycInfos.idType == 2">Driver's License</span>
              <span v-if="kycInfos.idType == 3">Government ID</span>
            </td>
            <td class="kyc-label-col-2">
            ...
            <td class="kyc-input-col-3">{{ kycInfos.idNumber }}</td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.address }}</td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.idIssuedOn }}</td>
            <td class="kyc-label-col-2">
              <span>Expiry</span>
              <br />
              <span>过期日</span>
            </td>
            <td class="kyc-input-col-3">{{ kycInfos.idExpireOn }}</td>
          </tr>
        </table>
            ...
            <td colspan="3" class="kyc-input-col-8" style="font-size: 12px">
              <div class="d-flex align-items-center mb-3">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.electronicOrTraditional == 'traditional'"
                />
              ...
              <div class="d-flex align-items-center">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.electronicOrTraditional == 'electronic'"
                />
                ...
                <div class="d-flex align-items-center ms-2">
                  <input
                    class="me-2"
                    type="checkbox"
                    :checked="kycInfos.electronicSourceOption == 'labGroup'"
                  />
                  <div>LAB group</div>
                </div>
                <div class="d-flex align-items-center ms-2 me-2">
                  <input
                    class="me-2"
                    type="checkbox"
                    :checked="kycInfos.electronicSourceOption == 'dataZoo'"
                  />
                  <div>Data Zoo</div>
                </div>
                ...
                <div class="d-flex align-items-center ms-2 me-2">
                  <input
                    class="me-2"
                    type="checkbox"
                    :checked="kycInfos.electronicSourceOption == 'refinitiv'"
                  />
                  <div>Refinitiv</div>
                </div>
                )
            ...
            <td class="kyc-input-col-5" style="font-size: 12px">
              <div class="d-flex align-items-center">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.traditionalOption == 'traditional1'"
                />
              ...
              <div class="d-flex align-items-center mt-3">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.traditionalOption == 'traditional2'"
                />
            ...
            <td class="kyc-input-col-5" style="font-size: 12px">
              ...
              <div class="d-flex align-items-center">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.electronicOption == '0'"
                />
                <div class="ms-3">
              ...
              <div class="d-flex align-items-center mt-3">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.electronicOption == '1'"
                />
                <div class="ms-3">
                  <div>
                    Reliable and independent electronic data from at least one
                    (1) separate data source <br />来自至少一 (1)
                    个单独数据源的可靠且独立的电子
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center mt-3">
                <input
                  class="me-2"
                  type="checkbox"
                  :checked="kycInfos.electronicOption == '2'"
                />
                <div class="ms-3">
                  <div>
                    A combination of both of the above <br />上面两者结合
                  </div>
                </div>
              </div>
            </td>
        ...
        <div class="mt-12">
          ...
          <div class="mb-5">
            <div>
              ...
              exceptional cases, we may use alternative identity proofing
              process, which are commensurate with our risk-based systems and
              controls.
            </div>
          </div>
          <div class="mb-5">
            <div>
              In these limited and exceptional cases, the matter will be
              referred to the AML/CTF compliance officer who may accept a
              self-attestation from the client, if they are not aware that the
              self-attestation is incorrect or misleading. The AML/CTF
              compliance officer will also designate the client as being high
              risk and will implement the appropriate level of ongoing customer
              due diligence procedures which is commensurate with a high risk
              client.
            </div>
          </div>
          <div class="mb-5">
      ...
      <div class="d-flex justify-content-around">
        <table style="width: 48%">
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.staffName }}</td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.staffPosition }}</td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">
              <img :src="kycInfos.staffSignature" height="80" alt="" />
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.staffSignedOn }}</td>
          </tr>
        </table>
        ...
        <table style="width: 48%">
          <tr>
            ...
            <td class="kyc-input-col-3">{{ kycInfos.complianceName }}</td>
          </tr>
          ...
          <tr>
            ...
            <td class="kyc-input-col-3">
              <img :src="kycInfos.complianceSignature" height="80" alt="" />
            </td>
          </tr>
      ...
      <div class="my-8">
        <div class="text-xs font-semibold mb-6 tracking-widerr">
          <div>
            You must verify the CLIENT’S FULL NAME and either their DATE OF
            BIRTH or RESIDENTIAL ADDRESS using:
          </div>
            ...
            <ul class="list-disc list-outside text-3xs">
              <li class="mb-2">
                <div>
                  ...
                  or equivalent authority of a foreign country for the purpose
                  of driving a vehicle that contains a photograph of the person
                  in whose name the document is issued;
                </div>
                <div>
              ...
              <li class="mb-2">
                <div>
                  ...
                  purpose of proving the person’s age which contains a
                  photograph of the person in whose name the document is issued.
                </div>
                <div>
                  ...
                  <ol class="list-decimal list-outside text-3xs mx-2">
                    ...
                    <li>
                      <div>
                        ...
                        language that is not understood by the person carrying
                        out the verification – is accompanied by an English
      ...
      <div
        class="text-xs font-semibold text-center w-full tracking-widerr mb-7"
      >
        OR / 或
      </div>
      ...
      <div class="p-4" style="border: 1px solid lightgray">
        ...
        <div class="px-8">
          <ul class="list-disc list-outside text-3xs">
            ...
            <li class="mb-2">
              <div>
                a citizenship certificate issued by a foreign government that,
                if it is written in a language that is not understood by the
                person carrying out the verification, is accompanied by an
            ...
            <li class="mb-2">
              <div>
                ...
                Nations or an agency of the United Nations that, if it is
                written in a language that is not understood by the person
            ...
            <li class="mb-2">
              ...
              <div class="px-8">
                <ol class="list-decimal list-outside text-3xs">
                  <li>
                    <div>
                      was issued to an individual by the Commonwealth, a State
                      or Territory within the preceding twelve months;
                    </div>
...
const convertToPdf = async () => {
  ...
  const element = document.getElementById("new-kyc-form") as HTMLElement;
  const opt = {
    margin: [0.5, 0.2],
...
const show = async (_kycInfos: any) => {
  formRef.value?.show();

  isLoading.value = true;
  kycInfos.value = _kycInfos;
  isLoading.value = false;
};
...
td,
th {
  page-break-inside: avoid; /* Ensure cells are not split */
}

ul,
ol {
  page-break-inside: auto; /* Avoid breaking the list */
}

li {
  page-break-inside: avoid; /* Ensure list items don't get split */
}
