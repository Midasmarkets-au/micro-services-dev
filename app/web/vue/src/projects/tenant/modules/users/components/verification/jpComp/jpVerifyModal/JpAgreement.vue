  ...
  <div class="box-container">
    ...
    >
      <div class="col-9 col-md-10 left">
        ...
        <div class="mb-1">
          <a :href="jpDocs.cfdTradingManual.src" target="_blank" class="pdf">
    ...
    >
      <div class="col-9 col-md-10 left">
        <div class="mb-1">
          <a :href="jpDocs.productCfdTrading.src" target="_blank" class="pdf">
...
const item = ref<any>(verificationDetails.value.financial);
onMounted(() => {
  formData.value = verificationDetails.value.agreement;
});
</script>
