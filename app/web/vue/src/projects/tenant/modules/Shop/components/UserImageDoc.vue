<template>
  <div style="width: 392px">
    ...
    <div v-if="!props.disabledAction" class="m-0 px-1">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="text-danger me-4 fw-bold fs-3" v-if="media?.status === 3">
            Rejected
          </div>
          <el-button
            v-if="media?.status === 0"
      ...
      <div class="fw-semibold fs-5 text-gray-600 text-dark mt-3 mb-5 d-flex">
        <template v-if="media?.status === 3">
          <h3 class="text-danger me-4">Reason:</h3>
          <p class="">{{ media.rejectedReason }}</p>
        </template>
      </div>
    </div>
  </div>
