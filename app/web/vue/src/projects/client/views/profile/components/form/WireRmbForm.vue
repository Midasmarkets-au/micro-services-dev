<template>
  <div class="mb-7">
    ...
    <div class="row mb-5">
      <div class="col-6 d-flex flex-column">
        <label for="" class="required mb-3">{{ $t("fields.state") }}</label>
        <Field
          type="text"
          class="form-control form-control-solid"
          name="state"
      ...
      <div class="col-6 d-flex flex-column">
        <label for="" class="required mb-3">{{ $t("fields.city") }}</label>
        <Field
          type="text"
          class="form-control form-control-solid"
          name="city"
...
const validationSchema = Yup.object().shape({
  ...
  branchName: Yup.string().required(t("error.__BRANCH_NAME_IS_REQUIRED__")),
  city: Yup.string().required(t("error.__CITY_IS_REQUIRED__")),
  state: Yup.string().required(t("error.__STATE_IS_REQUIRED__")),
});
