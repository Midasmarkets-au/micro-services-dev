<template>
  <div class="mb-7">
    ...
    <div class="row mb-5">
      ...
      <div class="col-6 d-flex flex-column">
        <label for="" class="mb-3">{{ $t("fields.swiftCode") }}</label>
        <Field
          type="text"
          class="form-control form-control-solid"
          name="swiftCode"
    ...
    <div class="row mb-5">
      ...
      <div class="col-6 d-flex flex-column">
        <label for="" class="mb-3">{{ $t("fields.branchName") }}</label>
        <Field
          type="text"
          class="form-control form-control-solid"
          name="branchName"
    ...
    <div class="row mb-5">
      <div class="col-6 d-flex flex-column">
        <label for="" class="mb-3">{{ $t("fields.state") }}</label>
        <Field
          type="text"
          class="form-control form-control-solid"
          name="state"
      ...
      <div class="col-6 d-flex flex-column">
        <label for="" class="mb-3">{{ $t("fields.city") }}</label>
        <Field
          type="text"
          class="form-control form-control-solid"
          name="city"
...
onMounted(() => {
  console.log("onMounted wire", props.data);
  if (props.data) {
