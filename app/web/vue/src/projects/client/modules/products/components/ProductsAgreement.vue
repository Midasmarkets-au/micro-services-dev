<template>
  <div class="card">
    <div class="card-body">
      ...
      <hr />
      <div>
        <el-form-item prop="accountRole" class="mb-10 account-type ms-2">
          <el-radio-group
      ...
      <div class="box-container">
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            ...
            >
              <el-checkbox v-model="formData.check_1">{{
                $t("fields.iAccept")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div
          class="row bottom"
          v-if="item.accountTypes.includes(accountTypes.margin)"
        >
          <div class="col-12 col-md-10 left">
            <div class="mb-1">
              <a
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_2">{{
                $t("fields.iAccept")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div
          class="row bottom"
          v-if="item.accountTypes.includes(accountTypes.cfdTrading)"
        >
          <div class="col-12 col-md-10 left">
            <div class="mb-1">
              <a
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_3">{{
                $t("fields.iAccept")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div
          class="row bottom"
          v-if="item.accountTypes.includes(accountTypes.productTrading)"
        >
          <div class="col-12 col-md-10 left">
            <div class="mb-1">
              <a
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_4">{{
                $t("fields.iAccept")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_5">{{
                $t("fields.iAccept")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_6">{{
                $t("action.yes")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_7">{{
                $t("action.yes")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_8">{{
                $t("action.yes")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_9">{{
                $t("action.yes")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row bottom">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_10">{{
                $t("action.yes")
              }}</el-checkbox>
            </el-form-item>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-2 right">
            <el-form-item
              ...
              class="d-flex align-items-center justify-content-center"
            >
              <el-checkbox v-model="formData.check_11">{{
                $t("action.yes")
              }}</el-checkbox>
            </el-form-item>
          </div>
...
import { accountRolesSelection } from "@/core/types/jp/verificationFinancial";
...
const agreements = ref<any>(items.value?.data?.agreement || {});

onMounted(() => {
  formData.value = agreements.value;
  formData.value.accountRole = item.value.accountRole;
...
::v-deep .account-type > .el-form-item__content {
