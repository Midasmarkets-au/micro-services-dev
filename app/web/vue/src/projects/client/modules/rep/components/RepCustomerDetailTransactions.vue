                ...
                <div class="d-flex align-items-center">
                  ...
                  >
                    <span class="symbol symbol-25px me-2">
                      <img src="/images/icons/finance/wallet-deposit.svg" />
                    </span>

                    <span> {{ $t("tip.transferOutToWallet") }} </span>
                  </label>
                  ...
                  >
                    <span class="symbol symbol-25px me-2">
                      <img src="/images/icons/finance/wallet-withdraw.svg" />
                    </span>

                    <span> {{ $t("tip.transferInFromWallet") }} </span>
                  </label>
...
const getTransactionHandler = (criteria: any) =>
  RepService.queryClientTransaction(accountUid.value, criteria);
