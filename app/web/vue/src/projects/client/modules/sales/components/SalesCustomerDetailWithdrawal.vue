...
import SalesWithdrawalFilter from "@/projects/client/modules/sales/components/SalesWithdrawalFilter.vue";
...
const filterOptions = ["size", "period", "withdrawalStatus"];
