<template>
  <div class="w-100 card">
        ...
        <div class="col-lg-12 pb-2">
          <el-form-item :label="$t('fields.address')" prop="address">
            <el-input
              ...
              size="large"
              autocomplete="off"
              name="disable_autofill_au_address"
            ></el-input>
          </el-form-item>
          <!-- <input class="formInput" id="au_address" /> -->
        </div>
      </div>
    </div>
    ...
    <div class="w-100 card-body mt-5">
      <!-- <div class="card-body">
      <div class="pb-3">
        <h2 class="fw-bold d-flex align-items-center text-dark">
          {{ $t("title.idDocument") }}
        ...
        <div class="col-lg-12 mb-3">
          ...
          >
            <div class="col-lg-12 mb-5 d-flex align-items-center">
              <label class="form-label fs-6 text-dark" style="width: 120px">{{
                $t("fields." + type.name)
              }}</label>
              <input
