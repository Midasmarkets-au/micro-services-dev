<template>
  <div
    ...
    :class="{
      'col-sm-12 col-md-7': itemsPerPageDropdownEnabled,
    }"
  >
      ...
      <ul class="pagination">
        ...
        >
          <a class="page-link" @click="onClickPreviousPage">
            <span class="svg-icon">
              <inline-svg src="/images/icons/arrows/arr074.svg" />
            </span>
          </a>
        </li>
        ...
        >
          <a class="paginate_button page-link" @click="onClickNextPage">
            <span class="svg-icon">
              <inline-svg src="/images/icons/arrows/arr071.svg" />
            </span>
          </a>
        </li>
        ...
        >
          <a class="paginate_button page-link" @click="onClickLastPage">
            <span class="svg-icon">
              <inline-svg src="/images/icons/arrows/arr080.svg" />
            </span>
          </a>
        </li>
      </ul>
