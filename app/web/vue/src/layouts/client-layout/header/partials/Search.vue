...
import Results from "@/layouts/client-layout/header/partials/search/Results.vue";
import Main from "@/layouts/client-layout/header/partials/search/Main.vue";
import Empty from "@/layouts/client-layout/header/partials/search/Empty.vue";
