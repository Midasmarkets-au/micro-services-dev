          ...
          >
            ...
            >
              ...
              <span class="menu-title"
                >{{ translate(menuItem.sectionTitle) }}fasdf2323123</span
              >
              ...
              <template v-for="(menuItem1, k) in menuItem.sub" :key="k">
                    ...
                    <template v-for="(menuItem2, l) in menuItem1.sub" :key="l">
                      <div class="menu-item">
                        ...
                        >
                          ...
                          <span class="menu-title"
                            >{{ translate(menuItem2.heading) }}fadsfasd</span
                          >
                        </router-link>
                      </div>
                    </template>
                ...
                <div v-if="menuItem1.heading" class="menu-item">
                  ...
                  >
                    ...
                    <span class="menu-title"
                      >{{ translate(menuItem1.heading) }}fadsfasdf
                    </span>
                  </router-link>
                </div>
              </template>
            ...
            >
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                  <inline-svg src="/images/icons/layouts/lay009.svg" />
                </span>
              </span>
              <span class="menu-title"
                >{{ translate(menuItem.heading) }}12312312</span
              >
            </router-link>
          </div>
        </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    // const mainMenu = inject("mainMenu");
