...
/**
 * 出金状态颜色映射（对应源项目 TransactionStateType）
 * 400=Created, 405=Canceled, 406=Failed,
 * 420=TenantApproved, 425=TenantRejected,
 * 430=PaymentCompleted, 450=Completed
 */
...
export default function RepWithdrawalPage() {
