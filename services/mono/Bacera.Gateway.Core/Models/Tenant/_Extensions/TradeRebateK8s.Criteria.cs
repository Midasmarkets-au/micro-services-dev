...
public partial class TradeRebateK8s : IEntity
{
    public sealed class Criteria : EntityCriteria<TradeRebateK8s>
    {
        public Criteria()
        {
            SortField = nameof(TradeRebateK8s.Id);
        }
        ...
        protected override void OnCollect(ICriteriaPool<TradeRebateK8s> pool)
        {
