...
// Producer: GeneralJob.Email.cs → NatsPublisher.PublishSendMessageAsync (subject: send.message)
// Consumer: scheduler/src/jobs/send_message_handler.rs (category=2 BatchEmail)
...
// {
//     private const int DefaultMaxNumberOfMessages = 10;
