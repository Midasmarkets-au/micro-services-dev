...
public sealed class UserTenantResponseModel
{
    ...
    public List<Configuration.ClientViewModel> Configurations { get; set; } = new();
    ...
    public static UserTenantResponseModel Of(User model, bool comment)
        => new()
        {
            Id = model.Id,
            Uid = model.Uid,
