...
public class WithdrawalUnionPayRecord : ICanExportToCsv
{
...
public static class WithdrawalUnionPayRecordExtension
{
    public static IQueryable<WithdrawalUnionPayRecord> ToUnionPayRecords(this IQueryable<Withdrawal> query)
        => query.Select(x => new WithdrawalUnionPayRecord
        {
